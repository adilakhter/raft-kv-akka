...
ssh -o StrictHostKeyChecking=no -i .deploy/deploy.pem ubuntu@52.214.224.105 "killall -9 java; nohup java -Dclustering.port=2552 -jar /home/ubuntu/raft.jar worker`</dev/null` >app2.log 2>&1 &"